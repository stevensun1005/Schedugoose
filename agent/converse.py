...
- Co-op options: Math has Regular plus four co-op sequences (Sequence 1-4; Seq 1 is most common, they differ in when work terms fall). Engineering has Stream 4 (earlier first work term) and Stream 8 (more time to settle in first). If asked, explain these; otherwise just ask which one they want.
